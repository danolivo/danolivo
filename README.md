...
* [Resilient collapse limit](https://github.com/danolivo/pgdev/tree/resilient-collapse-limit). This feature attempts to eliminate the effect of subplan pullups and other optimisations that cause join tree growth and, as a result, exceed the `join collapse limit` => bad query plans.
